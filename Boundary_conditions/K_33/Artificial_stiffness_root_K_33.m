   ...
   for k=3:number_of_nodes_K_L_le_y
    ...
    for k=3:number_of_nodes_M_N_le_y
     ...
     final_IJ=P_non_derive_I_J_x'*P_non_derive_I_J_y;
        ...
        K_33_alpha_root_trans=K_33_alpha_root_trans+((x_2-x_3)/4)*(final_MN)'*(final_IJ_root.*final_KL_root.*final_PQ_root.*final_MN_root.*final_RS_root)*weights_x(j)*weights_y(op);
    end
end