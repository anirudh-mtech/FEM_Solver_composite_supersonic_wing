...
sweep_angle=30;%degree
 b=13.56*10^3;%scaled to millimeter
 cr=6*10^3;%scaled to millimeter
 sweep_rad=30*(pi/180);
 b=b/2;
...
for boom=2:8
 ...
 Stiffness_of_spars_cap=FEM_Main_file_spars_cap(gauss_points_in_x,gauss_points_in_y,gauss_points_trans_x,gauss_points_trans_y,weights_in_x,weights_in_y,weights_trans_x,weights_trans_y,sweep_angle,b,cr,I,J,K,L,M,N,P,Q,R,S,l_1,h,h_1,theta(po),thickness_of_each_ply(po));
%  Stiffness_of_rib_web=FEM_Main_file_rib_web(gauss_points_in_x,gauss_points_in_y,gauss_points_trans_x,gauss_points_trans_y,weights_in_x,weights_in_y,weights_trans_x,weights_trans_y,sweep,b,cr,I_rib,J_rib,K_rib,L_rib,M_rib,N_rib,P_rib,Q_rib,R_rib,S_rib,h_2,t_2,h);
%  Stiffness_of_rib_cap=FEM_Main_file_ribs_cap(gauss_points_in_x,gauss_points_in_y,gauss_points_trans_x,gauss_points_trans_y,weights_in_x,weights_in_y,weights_trans_x,weights_trans_y,sweep,b,cr,I_rib,J_rib,K_rib,L_rib,M_rib,N_rib,P_rib,Q_rib,R_rib,S_rib,l_1,h_2,h,theta,thickness_of_each_ply);
  Stiffness_of_bc=Artificial_Stiffness(I,J,K,L,M,N,P,Q,R,S,sweep_angle,b,cr,gauss_points_in_x,gauss_points_in_y,gauss_points_trans_x,gauss_points_trans_y,weights_in_x,weights_in_y,weights_trans_x,weights_trans_y);
 Final_Stiffness=Stiffness_of_bc+Stiffness_of_spars_cap;%+Stiffness_of_rib_cap+Stiffness_of_rib_web+Stiffness_of_spars_cap+Stiffness_of_spars_web;Stiffness_of_skin
 force_local=[0;0;(5.2079);0;0];
 force_vector_final=force_vector(sweep_angle,cr,b,I,J,K,L,M,N,P,Q,R,S,gauss_points_in_x,gauss_points_in_y,gauss_points_in_z,weights_in_x,weights_in_y,force_local);
...
ylabel("Transverse displacement spar cap in mm")
