...
P_non_derive_I_J_x(1,2)=(l_1/c)*gauss_points_x(j)+spar_position_I_J(1);
P_derive_I_J_x(1,1)=0;
P_derive_I_J_x(1,2)=1;
P_non_derive_K_L_x(1,1)=1;
P_non_derive_K_L_x(1,2)=(l_1/c)*gauss_points_x(j)+spar_position_K_L(1);
P_derive_M_N_x(1,1)=0;
P_derive_M_N_x(1,2)=(l_1/c);
P_non_derive_M_N_x(1,1)=1;
P_non_derive_M_N_x(1,2)=(l_1/c)*gauss_points_x(j)+spar_position_M_N(1);
P_derive_M_N_x(1,1)=0;
P_derive_M_N_x(1,2)=(l_1/c);
P_non_derive_P_Q_x(1,1)=1;
P_non_derive_P_Q_x(1,2)=(l_1/c)*gauss_points_x(j)+spar_position_P_Q(1);
P_derive_P_Q_x(1,1)=0;
P_derive_P_Q_x(1,2)=(l_1/c);
P_non_derive_R_S_x(1,1)=1;
P_non_derive_R_S_x(1,2)=(l_1/c)*gauss_points_x(j)+spar_position_R_S(1);
P_derive_R_S_x(1,1)=0;
P_derive_R_S_x(1,2)=1;
P_non_derive_I_J_y(1,1)=1;
P_non_derive_I_J_y(1,2)=(l_1/c)*gauss_points_y(op)+spar_position_I_J(1);
P_derive_I_J_y(1,1)=0;
P_derive_I_J_y(1,2)=1;
P_non_derive_K_L_y(1,1)=1;
P_non_derive_K_L_y(1,2)=(l_1/c)*gauss_points_y(op)+spar_position_I_J(1);
P_derive_M_N_y(1,1)=0;
P_derive_M_N_y(1,2)=(l_1/c);
P_non_derive_M_N_y(1,1)=1;
P_non_derive_M_N_y(1,2)=(l_1/c)*gauss_points_y(op)+spar_position_P_Q(1);
P_derive_M_N_y(1,1)=0;
P_derive_M_N_y(1,2)=(l_1/c);
P_non_derive_P_Q_y(1,1)=1;
P_non_derive_P_Q_y(1,2)=(l_1/c)*gauss_points_y(op)+spar_position_P_Q(1);
P_derive_P_Q_y(1,1)=0;
P_derive_P_Q_y(1,2)=(l_1/c);
P_non_derive_R_S_y(1,1)=1;
P_non_derive_R_S_y(1,2)=(l_1/c)*gauss_points_y(op)+spar_position_R_S(1);
